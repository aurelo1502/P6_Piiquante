...
exports.createSauce = (req, res, next) => {
 let sauceFormat = (req.body.sauce);
  if (typeof sauceFormat !== 'object' && sauceFormat !== null) {              
    sauceFormat=JSON.parse(sauceFormat)
  }
  /*const type = typeof sauceObject !== 'object' && sauceObject !== null;  
  const sauce =  type ? req.body.sauce: ...JSON.parse(req.body.sauce);*/         
